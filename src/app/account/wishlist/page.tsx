        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-8">
              {/* Header */}
              <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 font-poppins mb-2">Wish List</h1>
              ...
              {wishlistItems.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {wishlistItems.map((product) => (
                    <div key={product.id} className="border-2 border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 transition-colors duration-200 group">
                      {/* Product Image */}
                      <div className="relative aspect-square overflow-hidden">
                        ...
                        {!product.inStock && (
                          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                            <span className="text-white font-semibold font-poppins">Out of Stock</span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="p-4">
                        <div className="mb-2">
                          <p className="text-xs text-gray-600 font-poppins font-medium">{product.category}</p>
                        ...
                        <div className="flex items-center gap-1 mb-3">
                          ...
                          <span className="text-xs text-gray-600 font-poppins">({product.reviewCount})</span>
                        </div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 font-poppins mb-2">Your wishlist is empty</h3>
