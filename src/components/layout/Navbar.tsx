      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-3 ml-6">
            {/* Wishlist */}
            <button className="p-3 text-gray-900 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-all duration-200 group min-h-[44px] min-w-[44px] flex items-center justify-center">
              <svg
            ...
            {/* Cart */}
            <button className="p-3 text-gray-900 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-all duration-200 relative group min-h-[44px] min-w-[44px] flex items-center justify-center">
              <svg
                className="h-6 w-6 group-hover:scale-110 transition-transform"
                fill="none"
                stroke="currentColor"
